...
class Saudacoes extends StatefulWidget {
  ...
  @override
  State<Saudacoes> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Saudacoes> {
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            child: const Text("Estou bem e você?"),
                          ),
                        ],
                      ),
                    ],
