...
class Sentimentos extends StatefulWidget {
  const Sentimentos({Key? key}) : super(key: key);

  @override
  State<Sentimentos> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Sentimentos> {
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            child: const Text("Eu estou feliz"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            child: const Text("Eu estou triste"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Eu estou preocupado";
                              });
                              _speak(texto);
                            },
                            child: const Text("Eu estou preocupado"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Eu estou preocupada";
                              });
                              _speak(texto);
                            },
                            child: const Text("Eu estou preocupada"),
                          ),
                        ],
                      ),
                    ],
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Eu estou surpreso";
                              });
                              _speak(texto);
                            },
                            child: const Text("Eu estou surpreso"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Eu estou surpresa";
                              });
                              _speak(texto);
                            },
                            child: const Text("Eu estou surpresa"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Eu estou bravo";
                              });
                              _speak(texto);
                            },
                            child: const Text("Eu estou bravo"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Eu estou brava";
                              });
                              _speak(texto);
                            },
                            child: const Text("Eu estou brava"),
                          ),
                        ],
                      ),
                    ],
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Eu estou com saudades";
                              });
                              _speak(texto);
                            },
                            child: const Text("Eu estou com saudades"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Eu estou alegre";
                              });
                              _speak(texto);
                            },
                            child: const Text("Eu estou alegre"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Eu estou entusiasmado";
                              });
                              _speak(texto);
                            },
                            child: const Text("Eu estou estusiasmado"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Eu estou estusiasmada";
                              });
                              _speak(texto);
                            },
                            child: const Text("Eu estou estusiasmada"),
                          ),
                        ],
                      ),
                    ],
