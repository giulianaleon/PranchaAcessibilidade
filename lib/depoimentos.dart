...
class Depoimentos extends StatefulWidget {
  ...
  @override
  State<Depoimentos> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Depoimentos> {
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            child: const Text("Eu não gostei"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Eu não preciso";
                              });
                              _speak(texto);
                            },
                            child: const Text("Eu não preciso"),
                          ),
                        ],
                      ),
