...
class SalaAula extends StatefulWidget {
  const SalaAula({Key? key}) : super(key: key);

  @override
  State<SalaAula> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<SalaAula> {
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            child: const Text("Tenho duvídas"),
                          ),
                        ],
                      ),
                    ],
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            child: const Text("Sala de Informática"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Tenho aula depois";
                              });
                              _speak(texto);
                            },
                            child: const Text("Tenho aula depois"),
                          ),
                        ],
                      ),
                    ],
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Preciso ir no banheiro";
                              });
                              _speak(texto);
                            },
                            child: const Text("Preciso ir no banheiro"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            child: const Text("Quero lanchar"),
                          ),
                        ],
                      ),
                      ...
                      Column(
                        children: [
                          ElevatedButton(
                            ...
                            onPressed: () {
                              setState(() {
                                texto = "Tenho mais aula hoje";
                              });
                              _speak(texto);
                            },
                            child: const Text("Tenho mais aula hoje"),
                          ),
                        ],
                      ),
                    ],
